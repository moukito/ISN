...
class Map:
    ...
    def get_chunk(self, chunk_coords):
        if self.map_chunks.get(chunk_coords, None) == None:
    ...
    def get_area_around_chunk(self, chunk_coords):
        ...
        for i in range(self.area_size * self.area_size):
            actual_chunk_coords = Point(chunk_coords.x + i // self.area_size - 1, chunk_coords.y + i % self.area_size - 1)
